  ...
  return (
    <>
      <div className="container mx-auto px-4 py-8">
        <h1 className='text-4xl text-center font-extrabold mb-8 text-gray-800 tracking-wide'>Get Your Data Analysis Report Now!</h1>
          ...
          <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-slate-100 p-4 rounded-lg shadow-lg">
              <div className="flex items-center space-x-2">
                ...
                <p>Generating Dashboard for {domain} ...</p>
              </div>
            </div>
          </div>
        )}
